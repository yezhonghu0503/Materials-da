export default {
  'menu.form.step': '工长管理',
  'menu.form.step.number': '工长名称',
  'menu.form.step.number.placeholder': '请输入工长名称',
  'menu.form.step.name': '电话号码',
  'menu.form.step.name.placeholder': '请输入电话号码',
  ...
  // columns
  'searchTable.columns.number': '电话号码',
