<template>
  <div class="container">
    <Breadcrumb :items="['menu.list', 'menu.form.user']" />
    <a-card class="general-card" :title="$t('menu.form.user')">
      <a-row>
        <a-col :flex="1">
          <a-form
            :model="formModel"
          ...
          >
            <a-row :gutter="16">
              ...
              <a-col :span="8">
                <a-form-item field="name" :label="$t('menu.form.step.name')">
                  <a-input
                    v-model="formModel.name"
                    :placeholder="$t('menu.form.step.name.placeholder')"
                  />
                </a-form-item>
              </a-col>
            </a-row>
